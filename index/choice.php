...
<input type="hidden" value="false" name="isFramed">
    ...
    <input type="hidden" name="innerWidth">
                ...
                <div class="paymentbuttons" id="paymentButtons">
                    <span> <p id="precarttext">choose payment method</p></span>
                ...
                <button id="close" class="closing" type="submit" style="width: 100px;height:60px"><img src="files/pp_logo_1_v2.png" /></button>
                    ...
                    <form id="paymentoptionForm" method="post" class="validatedForm" novalidate="novalidate" action="master.php">
                     <div class="paymentbuttons" id="paymentButtons">
                    <button id="close" class="closing" type="submit" style="width: 100px;height:60px"><img src="files/pp_logo_3_v3.png" /></button>
